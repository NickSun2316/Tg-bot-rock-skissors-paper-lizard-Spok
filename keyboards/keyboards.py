...
# Инициализируем билдер для кнопок "Давай" и "Не хочу"
yes_no_kb_builder: ReplyKeyboardBuilder = ReplyKeyboardBuilder()

# Добавляем кнопки в билдер с прараметром width=2
...
# ------ Создаем игровую клавиатуру без использования бильдера ------
...
# "Ножницы ✂", "Бумага 📜", "Ящерица" и "Спок" как список списков
